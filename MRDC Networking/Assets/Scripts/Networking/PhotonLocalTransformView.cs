...
/// <summary>
/// Component adapted from Photon Unity Networking's built in Photon Transform View.
/// What makes this different is that it is for synchronizing local transform values
/// instead of global transform values.
/// </summary>
[AddComponentMenu("Photon Networking/Photon Local Transform View")]
[HelpURL("https://doc.photonengine.com/en-us/pun/v2/gameplay/synchronization-and-state")]
[RequireComponent(typeof(PhotonView))]
public class PhotonLocalTransformView : MonoBehaviour, IPunObservable
{
